...
# YOLOv9 目标检测模型路径
yolo_weights = r'E:\ABB\segment-anything\runs\train\exp19\weights\best.pt'
source = r'E:\ABB\AI\Depth-Anything-V2\Inter_Realsence_D345_Datasets\color_image_20241026-194401.jpg'
...
if __name__ == "__main__":
    ...
    # 结果保存路径
    save_folder = r'E:\ABB\segment-anything\output_individual\SAM26'
    save_complete_image_path = r'E:\ABB\AI\Depth-Anything-V2\Inter_Realsence_D345_Datasets\color_image_20241026-194401.jpg'
    os.makedirs(save_folder, exist_ok=True)
    ...
    for idx, detection in enumerate(detections):
        ...
        # 保存每个单独目标的分割结果
        save_path = os.path.join(save_folder, f"segment_{idx}_{class_name}.jpg")
        save_individual_segment(img0, mask, bbox, f"{class_name} {confidence:.2f}", save_path)
    ...
    # 保存带有所有目标分割掩码的完整图片
    save_complete_segmented_image(img0, masks, bboxes, labels, save_complete_image_path)
