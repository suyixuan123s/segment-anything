...
def save_individual_segment(img, mask, bbox, label, save_path):
    ...
    # 裁剪目标区域，确保标签部分不被包含
    cropped_img = segmented_img[max(0, y0):min(img_height, y1), max(0, x0):min(img_width, x1)]
...
if __name__ == "__main__":
    ...
    input_image_path = r'E:\ABB\segment-anything\output_individual\YOLOv9\exp\color_image_20241022-143158.jpg'
    yolo_txt_path = r'E:\ABB\segment-anything\output_individual\YOLOv9\exp\color_image_20241022-143158.txt'
    image_path = r'E:\ABB\AI\Depth-Anything-V2\Inter_Realsence_D345_Datasets\color_image_20241022-143158.jpg'

    # 结果保存路径
    save_folder_individual = r'E:\ABB\segment-anything\output_individual\SAM2'
    save_complete_image_path = r'E:\ABB\segment-anything\output\complete_segmented_image.jpg'
