...
from Test.YOLOv9_Detect_API import DetectAPI
...
# 加载 RGB 和深度图像
rgb_image_path = "E:/ABB/AI/Depth-Anything-V2/Inter_Realsence_D345_Datasets/color_image_20241026-194402.jpg"
depth_image_path = "E:/ABB/AI/Depth-Anything-V2/Inter_Realsence_D345_Datasets/depth_image_20241026-194402.png"
...
# 保存带有检测信息的图像
output_image_path = r"E:\ABB\segment-anything\realsense_yolov9_simulation_detection\detected_simulation_image.jpg"
cv2.imwrite(output_image_path, rgb_image)

# 保存检测数据到 CSV 文件
csv_path = r'E:\ABB\segment-anything\realsense_yolov9_simulation_detection\detection_results_simulation_coords.csv'
# 检查并创建路径中的目录
