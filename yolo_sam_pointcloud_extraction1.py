...
source = r'E:\ABB\AI\Depth-Anything-V2\Inter_Realsence_D345_Datasets\color_image_20241026-194402.jpg'  # 输入图像路径
depth_image_path = r'E:\ABB\AI\Depth-Anything-V2\Inter_Realsence_D345_Datasets\depth_image_20241026-194402.png'  # 深度图像路径
...
if __name__ == "__main__":
    ...
    # 主结果文件夹路径
    save_folder = r'E:\ABB\segment-anything\realsense_yolov9_simulation_detection\SAM277'
    ...
    for idx, detection in enumerate(detections):
        ...
        sim_coords = extract_point_cloud_from_mask_ply(depth_image, mask, intrinsics, transformation_matrix, ply_save_path)
