...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint-path", type=str, default="E:/ABB/segment-anything/weights/sam_vit_h_4b8939.pth")
    parser.add_argument("--model_type", type=str, default="default")
    parser.add_argument("--onnx-model-path", type=str, default="E:/ABB/segment-anything/dataset_path/sam_onnx.onnx")
